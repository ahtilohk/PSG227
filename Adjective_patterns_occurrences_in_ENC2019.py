                    ...
                    for i in range(0, n):
                        ...
                        if i < n-1:
                            ...
                            if isinstance(lemmas[i+1], str): 
                                ...
                                if postags[i] == 'D' and words[i].lower() not in ignored_words and  (lemmas[i+1].lower() in test_words or words[i+1].lower() in special_words):
